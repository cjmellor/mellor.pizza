<nav x-data="{ showDropdown: false }">
    ...
    <div class="sm:hidden" id="mobile-menu" x-collapse x-show="showDropdown">
        ...
        <div class="pt-4 pb-3 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <button
                    class="ml-auto flex-shrink-0 bg-white p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pizza dark:focus:ring-pizza-dark"
                    type="button">
                    <span class="sr-only">View notifications</span>
