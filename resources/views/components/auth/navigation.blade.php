<nav x-data="{ showDropdown: false }">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    ...
                    >
                        <svg
                            class="h-6 w-6 text-gray-500 hover:text-gray-700 dark:text-slate-400 hover:dark:text-slate-200"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                    ...
                    <x-link
                        ...
                        :active="request()->routeIs('fos.index')"
                    ...
                    <x-link
                        class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                        :active="request()->routeIs('fos.posts.create')"
            ...
            <div class="hidden sm:flex sm:items-center sm:justify-between sm:w-48">
                ...
                <div class="relative">
                    ...
                    >
                        ...
                        <a
                            class="block cursor-pointer px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"
                            id="user-menu-item-2"
                            role="menuitem"
                            tabindex="-1"
                        >
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                ...
                >
                    ...
                    <svg
                        ...
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        x-bind:class="{ 'hidden': showDropdown, 'block': !showDropdown }"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path
    ...
    >
        <div class="sm:pt-2 pb-3 space-y-1">
            @if (!isAdminSection())
                <a
                    class="bg-pizza/10 dark:bg-pizza-dark/10 border-pizza dark:border-pizza-dark text-pizza dark:text-pizza-dark block pl-3 pr-4 py-2 border-l-4 text-base font-medium"
                    href="{{ route('fos.index') }}"
                >Admin</a>
            @endif
            <a
