        ...
        <nav class="px-4 flex items-center justify-between sm:px-0">
            ...
            @else
                <div class="-mt-px w-0 flex-1 flex">
                    ...
                    >
                        <svg aria-hidden="true" class="mr-3 h-5 w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20"
            ...
            @if($paginator->hasMorePages())
                <div class="-mt-px w-0 flex-1 flex justify-end">
                    ...
                    >
                        Next
                        <svg aria-hidden="true" class="ml-3 h-5 w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path clip-rule="evenodd"
