        ...
        <nav class="px-4 flex items-center justify-between sm:px-0">
            ...
            @else
                <div class="-mt-px w-0 flex-1 flex">
                    <x-link
                        :livewire="true"
                        class="border-t-2 border-transparent cursor-pointer pt-4 pr-1 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700"
            ...
            @if($paginator->hasMorePages())
                <div class="-mt-px w-0 flex-1 flex justify-end">
                    <x-link :livewire="true"
                            class="border-t-2 border-transparent cursor-pointer pt-4 pl-1 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700"
                            wire:click="nextPage">
                        Next
